...
import shadowmods.mhm.MobHives_Entities.EntityExplosiveArrow;

public class RenderExplosiveArrow extends Render {
  private static final ResourceLocation arrowTextures = new ResourceLocation("textures/entity/arrow.png");

  public void doRender(EntityExplosiveArrow p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
  ...
  protected ResourceLocation getEntityTexture(EntityExplosiveArrow p_110775_1_) {
    return arrowTextures;
  }
  
  protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
    return getEntityTexture((EntityExplosiveArrow)p_110775_1_);
  }
  
  public void doRender(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
    doRender((EntityExplosiveArrow)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
  }
}
