...
import shadowmods.mhm.MobHives_ImportantClasses.EntityAIHiveCreeperSwell;

public class EntityHiveCreeper extends EntityMob {
  ...
  public EntityHiveCreeper(World p_i1733_1_) {
    super(p_i1733_1_);
    this.tasks.addTask(1, new EntityAISwimming((EntityLiving)this));
    this.tasks.addTask(2, new EntityAIHiveCreeperSwell(this));
    this.tasks.addTask(3, new EntityAIAvoidEntity((EntityCreature)this, EntityOcelot.class, 6.0F, 1.0D, 1.2D));
    ...
    this.tasks.addTask(6, (EntityAIBase)new EntityAIWatchClosest((EntityLiving)this, EntityPlayer.class, 40.0F));
  ...
  public EntityHiveCreeper(World world, double x, double y, double z) {
    this(world);
    setPosition(x, y, z);
  }
