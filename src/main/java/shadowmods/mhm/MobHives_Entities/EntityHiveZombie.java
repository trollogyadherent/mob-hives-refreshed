...
public class EntityHiveZombie extends EntityMob {
  ...
  public EntityHiveZombie(World world, double x, double y, double z) {
    this(world);
    setPosition(x, y, z);
  }
  ...
  protected void dropRareDrop(int p_70600_1_) {
    entityDropItem(new ItemStack(Items.stone_sword, 1, 1), 0.0F);
  }
