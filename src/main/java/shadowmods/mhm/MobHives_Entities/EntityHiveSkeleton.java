...
public class EntityHiveSkeleton extends EntityMob implements IRangedAttackMob {
  private EntityAIArrowAttack aiArrowAttack = new EntityAIArrowAttack(this, 1.0D, 20, 60, 40.0F);
  
  private EntityAIAttackOnCollide aiAttackOnCollide = new EntityAIAttackOnCollide(this, EntityPlayer.class, 1.2D, false);
  
  public EntityHiveSkeleton(World world) {
    super(world);
    setSize(1.0F, 2.0F);
    ...
    setCurrentItemOrArmor(2, new ItemStack(Items.iron_leggings));
    setCurrentItemOrArmor(1, new ItemStack(Items.iron_boots));
    if (world != null && !world.isRemote)
      setCombatTask(); 
  }
  
  public EntityHiveSkeleton(World world, double x, double y, double z) {
    this(world);
    setPosition(x, y, z);
  }
  ...
  protected void dropRareDrop(int p_70600_1_) {
    entityDropItem(new ItemStack(Items.bow, 1, 1), 0.0F);
  }
  ...
  public void attackEntityWithRangedAttack(EntityLivingBase p_82196_1_, float p_82196_2_) {
    EntityExplosiveArrow entityarrow = new EntityExplosiveArrow(this.worldObj, this, p_82196_1_, 1.6F, (14 - this.worldObj.difficultySetting.getDifficultyId() * 4));
