...
public class CreeperHive extends Block {
  public IIcon[] icons = new IIcon[6];
  
  public CreeperHive(Material material) {
    super(material);
    setBlockName("CreeperHive");
    setBlockTextureName("mhm:ch");
  }
  ...
  public void updateTick(World world, int x, int y, int z, Random rndm) {
    ...
    if (world.getClosestVulnerablePlayer(x, y, z, 25.0D) != null) {
      ...
      for (int v = 0; v < Config.ssp; v++)
        world.spawnEntityInWorld(new EntityHiveCreeper(world, x, (y + 1), z));
    } 
  }
}
