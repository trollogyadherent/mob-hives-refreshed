...
public class SpiderHive extends Block {
  public IIcon[] icons = new IIcon[6];
  
  public SpiderHive(Material material) {
    super(material);
    setBlockName("SpiderHive");
    setBlockTextureName("mhm:sph");
  }
  ...
  public void updateTick(World world, int x, int y, int z, Random rndm) {
    ...
    if (world.getClosestVulnerablePlayer(x, y, z, 25.0D) != null) {
      ...
      for (int v = 0; v < Config.ssp; v++)
        world.spawnEntityInWorld(new EntityHiveSpiderRegular(world, x, (y + 1), z));
    } 
  }
}
