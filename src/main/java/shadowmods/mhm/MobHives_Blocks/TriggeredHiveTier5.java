...
import shadowmods.mhm.MobHives_ImportantClasses.Tier5HiveForces;
import shadowmods.mhm.MobHives_TileEntities.HiveTier5TE;

public class TriggeredHiveTier5 extends Block implements ITileEntityProvider {
  public static ForgeChunkManager.Ticket ticket;
  
  public IIcon[] icons = new IIcon[6];
  
  public TriggeredHiveTier5(Material material) {
    super(material);
    setBlockName("TriggeredHiveTier5");
    setBlockTextureName("mhm:ht5");
  }
  ...
  public void onBlockAdded(World world, int x, int y, int z) {
    if (!world.isRemote) {
      ...
      Tier5HiveForces.spawnHiveForces(world, x, y + 1, z);
    } 
  }
  
  public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
    return new HiveTier5TE();
  }
