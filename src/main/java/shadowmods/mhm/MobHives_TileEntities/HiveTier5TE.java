...
public class HiveTier5TE extends TileEntity {
  ...
  public void updateEntity() {
    ...
    if (!this.triedToAssignTicket && !this.worldObj.isRemote) {
      ...
      if (this.ticket == null) {
        System.out.println("Ticket could not be reserved for Tier 5 Hive @ (" + this.xCoord + "," + this.yCoord + "," + this.zCoord + ")");
      } else {
    ...
    if (this.worldObj.getClosestVulnerablePlayer(this.xCoord, this.yCoord, this.zCoord, 50.0D) == null)
      this.worldObj.setBlock(this.xCoord, this.yCoord, this.zCoord, mhm_Blocks.ht5);
    ...
    if (!found) {
      ...
      if (schest.getStackInSlot(0) == null)
        schest.setInventorySlotContents(0, new ItemStack(Items.iron_ingot, 64)); 
      if (schest.getStackInSlot(1) == null)
        schest.setInventorySlotContents(1, new ItemStack(Items.gunpowder, 64)); 
      if (schest.getStackInSlot(2) == null)
        schest.setInventorySlotContents(2, new ItemStack(Items.gold_ingot, 32)); 
      if (schest.getStackInSlot(3) == null)
        schest.setInventorySlotContents(3, new ItemStack(Blocks.obsidian, 16)); 
      if (schest.getStackInSlot(4) == null)
        schest.setInventorySlotContents(4, new ItemStack(Items.ender_pearl, 8)); 
    } 
  }
}
