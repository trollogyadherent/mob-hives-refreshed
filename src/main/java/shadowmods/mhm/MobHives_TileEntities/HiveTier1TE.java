...
public class HiveTier1TE extends TileEntity {
  ...
  public void updateEntity() {
    ...
    if (!this.triedToAssignTicket && !this.worldObj.isRemote) {
      ...
      if (this.ticket == null) {
        System.out.println("Ticket could not be reserved for Tier 1 Hive @ (" + this.xCoord + "," + this.yCoord + "," + this.zCoord + ")");
      } else {
    ...
    if (this.worldObj.getClosestVulnerablePlayer(this.xCoord, this.yCoord, this.zCoord, 50.0D) == null)
      this.worldObj.setBlock(this.xCoord, this.yCoord, this.zCoord, mhm_Blocks.ht1);
    ...
    if (!found) {
      ...
      if (schest.getStackInSlot(1) == null)
        schest.setInventorySlotContents(1, new ItemStack(Items.stick, 16)); 
      ...
      if (schest.getStackInSlot(3) == null)
        schest.setInventorySlotContents(3, new ItemStack(Blocks.log, 16)); 
      if (schest.getStackInSlot(4) == null)
        schest.setInventorySlotContents(4, new ItemStack(Blocks.cobblestone, 16)); 
    } 
  }
}
