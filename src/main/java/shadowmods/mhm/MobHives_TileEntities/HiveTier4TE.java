...
public class HiveTier4TE extends TileEntity {
  ...
  public void updateEntity() {
    ...
    if (!this.triedToAssignTicket && !this.worldObj.isRemote) {
      ...
      if (this.ticket == null) {
        System.out.println("Ticket could not be reserved for Tier 4 Hive @ (" + this.xCoord + "," + this.yCoord + "," + this.zCoord + ")");
      } else {
    ...
    if (this.worldObj.getClosestVulnerablePlayer(this.xCoord, this.yCoord, this.zCoord, 50.0D) == null)
      this.worldObj.setBlock(this.xCoord, this.yCoord, this.zCoord, mhm_Blocks.ht4);
    ...
    if (!found) {
      ...
      if (schest.getStackInSlot(0) == null)
        schest.setInventorySlotContents(0, new ItemStack(Items.iron_ingot, 48)); 
      if (schest.getStackInSlot(1) == null)
        schest.setInventorySlotContents(1, new ItemStack(Items.flint, 48)); 
      if (schest.getStackInSlot(2) == null)
        schest.setInventorySlotContents(2, new ItemStack(Items.cooked_beef, 48)); 
      if (schest.getStackInSlot(3) == null)
        schest.setInventorySlotContents(3, new ItemStack(Items.gunpowder, 16)); 
